<script>
    ...
    import { cpu_percent, proc_cpu_percent, mem_percent, proc_mem_pretty, num_clients} from "../stores/stats";
    import { fly } from "svelte/transition";
    //https://www.xicons.org/#/
</script>

<div class="shadow fixed bottom-3 md:right-3 z-40 md:left-auto left-3 right-3 transition-all duration-100 flex justify-center" transition:fly={{ y: 10, duration: 200 }}>
    <div class="stats">
        ...
        <div class="stat relative">
            ...
            <div class="stat-desc">({$proc_cpu_percent}%)</div>
        </div>
        ...
        <div class="stat relative">
            ...
            <div class="stat-desc">({$proc_mem_pretty})</div>
